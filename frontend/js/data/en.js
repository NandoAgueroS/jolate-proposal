export const en = {
  ...
  'acerca_de.p1': 'The <strong class="text-primary">Latin American Meetings on Economic Theory (JOLATE)</strong> are one of the leading academic forums in Latin America dedicated to mathematical economics and formal approaches to economic theory. Since their creation, they have brought together researchers, faculty members, and graduate students from the region and other parts of the world to exchange ideas and discuss the latest advances in these fields of research.',
  ...
  'convocatoria.text': 'The XXV Latin American Meetings on Economic Theory (JOLATE 2026) invite researchers and researchers in training, as well as graduate students, to submit original papers in Mathematical Economics and Economic Theory, with a special emphasis on highly formalized approaches.',
  'convocatoria.text_evaluation': 'All contributions will be evaluated by the Scientific Committee, which will consider their quality, originality, and analytical contribution.',
  'convocatoria.text_deadline': 'The deadline for submitting papers is September 4, 2026. Acceptance notifications will be sent before September 18, 2026.',
  ...
  'inscripcion.description': 'Registration for the XXV Latin American Meetings on Economic Theory (JOLATE 2026) is open to researchers, lecturers, undergraduate and graduate students, and professionals interested in Mathematical Economics and Economic Theory.',
  'inscripcion.description_invitation': 'We invite you to take part in this 25th edition, which celebrates 25 years of academic exchange and scientific collaboration in Latin America.',
  'inscripcion.description_participation': 'To participate in the meetings, please complete the registration form below.',
  'convocatoria.format_title': 'Required Format',
  'convocatoria.format_01': '<strong>PDF</strong> format exclusively',
  'convocatoria.format_02': 'Include title, authors, and institutional affiliation',
  'convocatoria.format_03': 'Follow the guidelines of the selected thematic area',
  ...
  'enviar.exito_expositor': '\u2713 Paper submitted successfully! It has been registered in the public system activity. You\'ll receive a confirmation email shortly.',
  'enviar.exito_asistente': '\u2713 Registration registered successfully! You\'ll receive a confirmation email shortly.',
  ...
  'expos_form.description': 'Please complete your personal information exactly as you would like it to appear on your exhibitor certificate.',
  'expos_form.description_abstract': 'Next, attach the abstract of your research paper in PDF format. The abstract must not exceed one (1) page.',
