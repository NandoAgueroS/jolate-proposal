export const es = {
  ...
  'acerca_de.p1': 'Las <strong class="text-primary">Jornadas Latinoamericanas de Teoría Económica (JOLATE)</strong> constituyen uno de los principales foros académicos de América Latina dedicados a la Economía Matemática y a los enfoques formales de la Teoría Económica. Desde su creación, han reunido a investigadores, docentes y estudiantes de posgrado de la región y de otras partes del mundo para intercambiar ideas y debatir los avances más recientes en estas áreas de investigación.',
  'acerca_de.p2': 'En su <strong class="text-text">XXV edición</strong>, que conmemora 25 años de trayectoria académica, las jornadas se realizarán en <strong class="text-text">San Luis, Argentina</strong>, y serán coorganizadas por la <strong class="text-text">Universidad de La Punta (ULP)</strong> y la <strong class="text-text">Universidad Nacional de San Luis (UNSL)</strong>, a través del <strong class="text-text">Instituto de Matemática Aplicada San Luis (IMASL-CONICET)</strong> y del <strong class="text-text">Departamento de Matemática de la Facultad de Ciencias Físico, Matemáticas y Naturales</strong>, con el apoyo del <strong class="text-text">Consejo Nacional de Investigaciones Científicas y Técnicas (CONICET)</strong> y del Gobierno de la Provincia de San Luis.',
  ...
  'convocatoria.text_evaluation': 'Todas las contribuciones ser\u00e1n evaluadas por el Comit\u00e9 Cient\u00edfico, que considerar\u00e1 su calidad, originalidad y aporte anal\u00edtico.',
  'convocatoria.text_deadline': 'La fecha l\u00edmite para la recepci\u00f3n de trabajos es el 4 de septiembre de 2026. La notificaci\u00f3n de aceptaci\u00f3n ser\u00e1 comunicada antes del 18 de septiembre de 2026.',
  ...
  'inscripcion.description': 'La inscripci\u00f3n a las XXV Jornadas Latinoamericanas de Teor\u00eda Econ\u00f3mica (JOLATE 2026) est\u00e1 abierta a investigadores, docentes, estudiantes de grado y de posgrado, y profesionales interesados en la Econom\u00eda Matem\u00e1tica y la Teor\u00eda Econ\u00f3mica.',
  'inscripcion.description_invitation': 'Los invitamos a formar parte de esta XXV edici\u00f3n, que celebra 25 a\u00f1os de intercambio acad\u00e9mico y colaboraci\u00f3n cient\u00edfica en Am\u00e9rica Latina.',
  'inscripcion.description_participation': 'Para participar en las jornadas, complete el formulario de inscripci\u00f3n disponible a continuaci\u00f3n.',
  'convocatoria.format_title': 'Formato Requerido',
  'convocatoria.format_01': 'Formato <strong>PDF</strong> exclusivamente',
  'convocatoria.format_02': 'Incluir t\u00edtulo, autores y afiliaci\u00f3n institucional',
  'convocatoria.format_03': 'Respetar los lineamientos del eje tem\u00e1tico seleccionado',
  ...
  'enviar.exito_expositor': '\u2713 \u00a1Ponencia cargada correctamente! Se ha registrado en la actividad p\u00fablica del sistema. Recibir\u00e1s un correo de confirmaci\u00f3n en breve.',
  'enviar.exito_asistente': '\u2713 \u00a1Inscripci\u00f3n registrada correctamente! Recibir\u00e1s un correo de confirmaci\u00f3n en breve.',
  ...
  'enviar.error_upload_ini': 'El archivo supera el l\u00edmite de subida permitido. Comprim\u00ed el PDF e intent\u00e1 nuevamente.',
  'enviar.error_upload_form': 'El archivo supera el tama\u00f1o m\u00e1ximo permitido de {max} MB.',
  'enviar.error_upload_partial': 'La subida del archivo se interrumpi\u00f3. Intent\u00e1 nuevamente.',
  'enviar.error_upload_tmp': 'No se pudo recibir el archivo. Intent\u00e1 nuevamente en unos minutos.',
  'enviar.error_upload_ext': 'Este tipo de archivo no est\u00e1 permitido. Prob\u00e1 con otro archivo.',
  'enviar.error_upload_unknown': 'Error al subir el archivo. Intent\u00e1 nuevamente.',
  'enviar.error_server': 'Algo sali\u00f3 mal al procesar tu solicitud. Intent\u00e1 nuevamente en unos minutos.',
  'enviar.error_timeout': 'La solicitud tard\u00f3 demasiado en completarse. Verific\u00e1 tu conexi\u00f3n e intent\u00e1 nuevamente.',
  ...
  'enviar.error_smtp_participant': 'La inscripci\u00f3n se registr\u00f3 pero no se pudo enviar el correo de confirmaci\u00f3n. No reenv\u00edes el formulario: contact\u00e1 al comit\u00e9 para confirmar.',
  'enviar.error_smtp_committee': 'La inscripci\u00f3n se registr\u00f3 pero no se pudo enviar la notificaci\u00f3n al comit\u00e9. No reenv\u00edes el formulario: contact\u00e1 al comit\u00e9 para confirmar.',
  ...
  'expos_form.description': 'Por favor, complete sus datos personales exactamente como desea que figuren en el certificado de expositor.',
  'expos_form.description_abstract': 'A continuaci\u00f3n, adjunte el resumen de su trabajo de investigaci\u00f3n en formato PDF. El resumen no debe superar una (1) p\u00e1gina.',
